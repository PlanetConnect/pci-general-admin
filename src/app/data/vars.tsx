...
export const ENV = String(import.meta.env.VITE_NODE_ENV);
...
export const COGNITO_USER_POOL_NAME = String(
  import.meta.env.VITE_COGNITO_USER_POOL_NAME
);
export const ISSUER = `https://cognito-idp.${REGION}.amazonaws.com/${COGNITO_USER_POOL_ID}`;
...
export const SCOPE = "openid profile email aws.cognito.signin.user.admin";
